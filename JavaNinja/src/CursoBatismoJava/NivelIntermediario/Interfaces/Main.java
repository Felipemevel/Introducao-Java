...
public class Main {
    public static void main(String[] args) {
        ...
        int anosFaltamBoruto = Boruto.anosParaHokage(30);
        ...
        System.out.println("<==============================");
        System.out.println("Nome: " + Boruto.nome + "\nIdade: " + Boruto.idade + " anos \n" + "Aldeia: " + Boruto.aldeia + "\nAnos minimos restantes para Hokage: " + anosFaltamBoruto);
        Boruto.AtivarJougan();
        Boruto.AtivarOKarma();
        Boruto.ModoSabio();
        System.out.println("==============================>\n");
